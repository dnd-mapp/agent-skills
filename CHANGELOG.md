...
- `html-outputs` skill: decides whether a spec, plan, report, or other rich output should be produced as HTML instead of Markdown, or built as a small interactive HTML tool. Also decides when Markdown is still the better fit.
