...
| Skill                                                  | Description                                                                                                                                                                                         |
|--------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [`address-comments`](skills/address-comments/SKILL.md) | Address existing comments on a pull request (review threads and general PR comments) with code changes, replies, and thread resolutions, reviewed with you before anything is applied.              |
